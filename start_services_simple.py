#!/usr/bin/env python3
"""
Startup script with simplified TF-IDF service
"""
...
SERVICES = {
    ...
    "tfidf": {
        "port": 8003,
        "command": ["python", "-m", "uvicorn", "services.tfidf_service.main_simple:app", "--host", "0.0.0.0", "--port", "8003"]
    },
    "embedding": {
        "port": 8004,
...
def main():
    ...
    print("🎯 Starting Information Retrieval System with Simplified TF-IDF")
    print("=" * 70)
    ...
    print("\n🔧 TF-IDF Service: Using simplified version (no pre-trained models required)")
    print("📊 Database: Direct access to ir_database_combined.db")
